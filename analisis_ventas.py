...
import numpy as np
import sys
from io import StringIO # Importación para manejo de excepciones si se necesita
...
# --- 2. Funciones de Validación y Cálculo (Funciones Integradas) ---
...
def calcular_metricas_clave(datos):
    ...
    validar_datos_entrada(datos) # Llama a la función de validación integrada
...
def generar_grafico_ventas_mensuales(datos):
    ...
    ...
    """
    # Se añade la validación aquí para seguridad, aunque ya se hará en calcular_metricas_clave
    validar_datos_entrada(datos) 
    configurar_estilo_grafico()
...
if __name__ == "__main__":
    ...
    datos_ventas = pd.Series([12500, 15000, 13800, 16500, 14200, 18000, 15500, 17200],
    ...
    try:
        ...
        print("Gráfico generado. Mostrando figura (puede tardar en aparecer...).")
        # plt.show() # Descomentar para ver el gráfico si se ejecuta en un entorno compatible (ej. Jupyter, IDE con backend gráfico)
